...
public class EditPostIngredientAdapter extends RecyclerView.Adapter {
    private Activity activity;
    private List<Ingredient> ingredientList;

    public EditPostIngredientAdapter(Activity activity, List<Ingredient> ingredientList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        EditRecipeGradientViewHolder holder = new EditRecipeGradientViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        EditRecipeGradientViewHolder viewHolder = (EditRecipeGradientViewHolder) holder;
        Ingredient model = ingredientList.get(position);
        model.setId(null);
        viewHolder.etGradientDetail.setText(model.getName());
    ...
    public class EditRecipeGradientViewHolder extends RecyclerView.ViewHolder {
        TextInputEditText etGradientDetail;
        ImageView ivRemoveItem;

        public EditRecipeGradientViewHolder(@NonNull View itemView) {
            super(itemView);
