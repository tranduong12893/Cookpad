...
public class EditInactivePostActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_inactive_post);
        initView();
        setSpinner();
    ...
    private void initView() {
        ...
        content = (Content) getIntent().getSerializableExtra("EDIT POST");
        id = content.getId();
        ...
        repository.getService().createPost(content).enqueue(new Callback<Content>() {
            ...
            public void onResponse(Call<Content> call, Response<Content> response) {
                if (response.code() == 200) {
                    Toast.makeText(EditInactivePostActivity.this, "Sửa bài thành công", Toast.LENGTH_SHORT).show();
                    deletePost(id);
                    finish();
                } else {
                    Toast.makeText(EditInactivePostActivity.this, "Sửa bài thất bại", Toast.LENGTH_LONG).show();
                }
            }
